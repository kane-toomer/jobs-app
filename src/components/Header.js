						...
						<div>
							<div className="hidden sm:mb-8 sm:flex sm:justify-center">
								<div className="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
									<span className="text-gray-600">
										Want to head back to my portfolio?.{" "}
										<a
							...
							<div>
								<h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
									Your job search is now simpler than ever
								</h1>
								<p className="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
									Search jobs by using the form below. If you don't want to
									enter any parameters, simply click the search button. For json
									data of each job visit{" "}
									<span>
										<a
